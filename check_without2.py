...
def robot_final_sequence(robot, gripper):
    ...
    joint_state = [1.1362388134002686, -1.1116756957820435, 1.6357525030719202, -2.1371146641173304, -1.587231461201803, -0.40445119539369756]
    robot.move_joint_list(joint_state, 0.25, 0.5, 0.02)

    joint_state = [1.1242824792861938, -1.0640432399562378, 1.6357930342303675, -2.1511007748045863, -1.5669520537005823, -0.40446597734560186]
    robot.move_joint_list(joint_state, 0.25, 0.5, 0.02)
    gripper.move(0, 125, 125)
