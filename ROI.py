...
# ROI for vial (adjusted as needed)
roi_x, roi_y, roi_w, roi_h = 200, 140, 170, 320
...
def detect_blue_intensity(frame):
    ...
    # Weighted hue-based blue intensity
...
def robot_initial_sequence(robot, gripper):
    robot.move_joint_list([1.7210407257080078, -1.4829945129207154, 1.0804827849017542, -1.2031756204417725, -1.5582359472857874, 0.187379851937294], 0.25, 0.5, 0.02)
    gripper.move(0, 125, 125)
    robot.move_joint_list([1.7016677856445312, -1.0396659535220643, 1.5966079870807093, -2.164830347100729, -1.6157248655902308, 0.09034441411495209], 0.25, 0.5, 0.02)
    gripper.move(255, 125, 125)
    robot.move_joint_list([1.7017242908477783, -1.9431821308531703, 1.5954573790179651, -1.2426818174174805, -1.6158016363727015, 0.09030354022979736], 0.25, 0.5, 0.02)
    #robot.move_joint_list(degreestorad([93.77, -89.07, 89.97, -90.01, -90.04, 0.0]), 0.5, 0.5, 0.02)
    robot.move_joint_list([1.2128186225891113, -2.079813619653219, 2.0105178991900843, -1.508144350056984, -1.6101000944720667, -0.38880664507021123], 0.25, 0.5, 0.02)
    gripper.move(255, 125, 125)
